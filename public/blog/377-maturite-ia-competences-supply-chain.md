...
description: "Une grille simple pour évaluer la maturité IA de vos collaborateurs supply chain, et construire un plan de montée en compétence individualisé plutôt qu'uniforme."
---

# Évaluer la Maturité IA de ses Collaborateurs Supply Chain
...
## Le tableau du plan de montée en compétence

| Niveau | Priorité de formation |
|---|---|
| Novice | Prise en main de base, cas d'usage simples |
| Utilisateur occasionnel | Structuration des prompts, méthode CRAF |
