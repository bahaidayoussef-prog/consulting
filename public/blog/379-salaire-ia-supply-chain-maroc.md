...
description: "L'IA fait-elle bouger la grille salariale supply chain au Maroc ? Ce qui se dessine réellement sur les profils hybrides, et ce qui reste inchangé pour l'instant."
---

# L'IA Change-t-elle la Grille Salariale Supply Chain Marocaine
...
## Le tableau de tendance par type de poste

| Type de poste | Impact IA sur la rémunération |
|---|---|
| Postes classiques (acheteur, planificateur) | Marginal pour l'instant, compétence métier reste prépondérante |
