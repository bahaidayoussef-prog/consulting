...
description: "Les questions de due diligence à poser à tout éditeur IA avant de signer : pérennité, sécurité, références, dépendance créée — la checklist complète."
---

# Due Diligence IA Fournisseur : les Questions Avant de Signer
...
## Le tableau de risque par profil d'éditeur

| Profil d'éditeur | Niveau de vigilance |
|---|---|
| Grand éditeur établi (Microsoft, SAP, Google) | Vigilance standard, focus sur les clauses contractuelles |
