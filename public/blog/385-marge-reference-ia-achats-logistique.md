...
description: "Comment l'IA calcule la marge réelle par référence en croisant achats, coûts logistiques et prix de vente, révélant des produits jugés rentables qui ne le sont pas."
---

# Piloter la Marge par Référence Grâce à l'IA
...
## Le tableau de la marge réelle vs affichée

| Type de référence | Marge affichée | Marge réelle après coûts logistiques |
|---|---|---|
