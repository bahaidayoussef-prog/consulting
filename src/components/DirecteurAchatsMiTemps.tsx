...
const PHASES: Phase[] = [
  {
    ...
    duration: '4 semaines',
    items: [
      'Audit achats et panel fournisseurs',
      'Cartographie du spend par catégorie',
      'Feuille de route priorisée',
      'Restitution Comité de Direction',
    ],
    deliverable: 'Plan de transformation achats validé',
  },
  {
    num: '02',
    ...
    duration: '3 à 5 mois',
    items: [
      'Direction opérationnelle achats 2 j/semaine',
      'KPIs achats en place (économies réalisées, délais)',
      'Négociation contrats-cadres & panel fournisseurs',
      'Montée en compétences des acheteurs',
    ],
    deliverable: 'Fonction achats pleinement opérationnelle',
  },
  {
    num: '03',
    name: 'Passation',
    ...
    items: [
      'Formation responsable achats interne',
      'Documentation processus achats clés',
      'Tableau de bord autonome livré',
      'Session de clôture avec DG',
    ],
    deliverable: 'Équipe achats autonome — exit propre',
  },
]
...
const MANDATS: Mandat[] = [
  ...
  },
  {
    ...
    includes: [
      '3 phases + structuration panel fournisseurs incluse',
      'Représentation CODIR / Comex possible',
      'Recrutement ou formation responsable achats interne',
...
const schema = {
  ...
  '@type': 'Service',
  name: 'Directeur Achats à Temps Partagé',
  serviceType: 'Direction achats externalisée',
  provider: { '@type': 'ProfessionalService', name: 'Essor Consulting' },
  areaServed: { '@type': 'Country', name: 'Maroc' },
  description: "Direction opérationnelle des achats, de la négociation fournisseurs et de la réduction des coûts d'achat à temps partagé, pour PME et ETI marocaines.",
}

export default function DirecteurAchatsMiTemps() {
  return (
    <>
      ...
      <div style={{ background: 'var(--paper)', padding: 'var(--sp) var(--sp-x) var(--sp-y-sm)' }}>
        <div className="section-inner">
          <FadeUp>
            <div className="section-tag"><span>Direction Achats · Temps Partagé</span></div>
          </FadeUp>
          <div className="dsc-header-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'end', marginTop: '1.5rem' }}>
            ...
            <FadeUp delay={0.15}>
              <p style={{ fontSize: '1rem', color: 'var(--mid)', lineHeight: 1.8, fontWeight: 300, marginBottom: '1.5rem' }}>
                Un directeur achats à temps partagé structure votre stratégie de sourcing, négocie vos contrats fournisseurs et pilote la réduction de vos coûts d&apos;achat — pas l&apos;ensemble de la fonction supply chain. Un mandat opérationnel, en 3 phases, avec un livrable garanti en sortie : une fonction achats autonome et outillée.
              </p>
              <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.62rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--blue-bright)', display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
                ...
                Sourcing · Négociation · Réduction des coûts d&apos;achat
              </div>
            </FadeUp>
          </div>
        </div>
          ...
          <FadeUp>
            <div style={{ borderLeft: '3px solid var(--blue-bright)', padding: '0.5rem 0 0.5rem 1.75rem', maxWidth: 720 }}>
              <p style={{ fontSize: '1.05rem', color: 'var(--ink)', lineHeight: 1.75, fontWeight: 300, fontStyle: 'italic', margin: 0 }}>
                Groupe Addoha — 31 chantiers simultanés, 710 millions MAD d&apos;achats annuels. La transformation de la fonction achats a permis 11% d&apos;économies réalisées sur le spend achats.
              </p>
            </div>
          </FadeUp>
        </div>
        ...
        <div className="section-inner">
          <FadeUp>
            <div style={{ maxWidth: 720 }}>
              ...
              <p style={{ fontSize: '1rem', color: 'var(--mid)', lineHeight: 1.8, fontWeight: 300, marginBottom: '1.5rem' }}>
                Un directeur achats en CDI coûte entre 600 000 et 900 000 MAD par an, charges sociales incluses, avec 4 à 6 mois de recrutement avant la prise de poste. Un mandat Essor démarre en 2 semaines, sans charges ni risque RH, avec un exit propre inclus dès la signature.
              </p>
              <Link
          ...
          <FadeUp>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '2rem', marginBottom: '3rem' }}>
              ...
              <Link to="/directeur-logistique-mi-temps" style={{ fontSize: '0.88rem', color: 'var(--mid)', textDecoration: 'none', borderBottom: '1px solid rgba(27,53,84,0.15)', paddingBottom: '2px' }}>
                Voir aussi : Directeur Logistique à temps partagé →
              </Link>
            </div>
          </FadeUp>
          <FadeUp delay={0.1}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '2rem' }}>
              <div>
                <div style={{ fontFamily: 'Manrope, sans-serif', fontSize: 'clamp(1.5rem, 2.8vw, 2.8rem)', fontWeight: 700, fontStyle: 'italic', color: 'var(--ink)', lineHeight: 1.15, marginBottom: '0.5rem' }}>
                  Prêt à démarrer un mandat achats ?
                </div>
