...
description: "Comment réorganiser une équipe achats ou logistique autour de l'IA : quels rôles évoluent, quelles fiches de poste changent, sans bouleverser tout l'organigramme."
---

# Réorganiser une Équipe Achats ou Logistique Autour de l'IA
...
## Le tableau de réaffectation type

| Rôle | Temps libéré | Temps réaffecté vers |
|---|---|---|
| Acheteur junior | Recherche fournisseur manuelle | Analyse de risque, négociation |
