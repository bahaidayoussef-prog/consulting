...
description: "Ce que la vision par ordinateur change pour l'audit qualité fournisseur à distance : ce qu'elle permet de vérifier, et ce qui exige toujours une visite terrain."
---

# Contrôle Qualité Fournisseur à Distance : ce que Change la Vision IA
...
## Ce qui exige toujours une visite physique

| Vérifiable à distance | Nécessite une visite physique |
|---|---|
| État visuel des installations | Odeurs, bruits, ambiance réelle de production |
