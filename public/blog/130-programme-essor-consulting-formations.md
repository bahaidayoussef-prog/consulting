...
### Programme 1 — Supply Chain Manager (5 jours)
**Pour qui :** Managers SC en poste ou en prise de poste.
...
**Contenu :** Stratégie SC, P&L, gestion des risques, leadership, présentation CODIR.
**Format :** 3 jours séminaire + 6 mois coaching mensuel (1h/mois).
**Tarif :** Sur devis selon le niveau d'accompagnement souhaité.
...
| Coaching individuel | Sessions 1-1 avec un consultant senior | Ultra-personnalisé |
| Hybride | E-learning + présentiel | Flexibilité + pratique |

## Nos Engagements

**1. Formateur praticien :** Consultant senior, 20 ans de missions terrain, 110+ clients, certifié DDMRP.
...
**Sessions inter-entreprises :** Planning disponible sur demande. Sessions mensuelles à Casablanca.

**Intra-entreprise :** Disponible toute l'année, sur vos dates, dans vos locaux ou dans une salle externe.
...
Premier échange gratuit (30 minutes) pour identifier le programme adapté à vos besoins.
