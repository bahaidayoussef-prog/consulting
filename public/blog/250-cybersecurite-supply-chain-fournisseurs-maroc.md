...
Une entreprise investit généralement plus dans la sécurité de son propre système d'information que dans celle de ses fournisseurs — logique, puisqu'elle ne contrôle pas directement leur infrastructure. C'est précisément cette asymétrie que les attaquants exploitent : infiltrer un prestataire informatique, un transporteur connecté au système de l'entreprise, ou un logiciel tiers utilisé en interne, plutôt que d'attaquer frontalement une cible mieux défendue. Le nombre d'incidents liés aux attaques de supply chain a augmenté de 47% en 2025 selon les données ENISA et CISA ([Board of Cyber](https://www.boardofcyber.io/ressources/tprm-academy/articles/4-attaques-supply-chain-2025-analyse-des-crises-et-anticipation-des-nouveaux-vecteurs-dattaque-pour-2026)).

::stat:: 45% — part des organisations mondiales qui auront subi une attaque via leur chaîne d'approvisionnement logicielle d'ici 2025 (Gartner, prévision 2021)
...
- [Board of Cyber — 4 attaques supply chain 2025 : analyse des crises et anticipation des nouveaux vecteurs d'attaque pour 2026](https://www.boardofcyber.io/ressources/tprm-academy/articles/4-attaques-supply-chain-2025-analyse-des-crises-et-anticipation-des-nouveaux-vecteurs-dattaque-pour-2026)
- [Supply Chain Digital — Supply Chain Cyber Attacks Hit 26% of Firms in Past Year](https://supplychaindigital.com/news/supply-chain-cyber-attacks-hit-26-of-firms-in-past-year)
