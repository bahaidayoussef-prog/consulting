...
::stat:: 10 à 20% — seuil de MAPE (taux d'erreur de prévision) généralement considéré comme acceptable en supply chain
...
- [ImperiaSCM — MAPE in Forecasting: Formula, Good Values and Limitations](https://imperiascm.com/blog/mape-and-supply-chain-forecasting-how-to-measure-and-enhance-accuracy)
- [EasyReplenish — Demand Forecast Accuracy: Metrics, Tools & Industry Benchmarks](https://www.easyreplenish.com/blog/demand-forecast-accuracy-metrics-tools-industry-benchmarks)
- [Optimix Software — Comment choisir son logiciel de prévision de vente ?](https://optimix-software.com/fr/blog/supplychain/comment-choisir-son-logiciel-de-prevision-de-vente/)
